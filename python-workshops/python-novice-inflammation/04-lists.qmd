...
abstract: |
  Learn to work with Python lists to store and manipulate multiple values. Master list creation, indexing, slicing, and modification techniques essential for handling collections of data in programming.
date: last-modified
format:
  html: default
authors-ipa:
...
keywords: ["Python", "Lists", "Data Structures", "Indexing", "Slicing", "Tutorial"]
license: "CC BY 4.0"
---
...
![Three-row shelf of vegetables with baskets containing lettuce, lettuce, and peppers in the top row](figures/04_groceries_veg.png)
...
![List representation of veg showing three rows with veg[0], veg[1], and veg[2] indexing](figures/04_groceries_veg0.png)
...
![Two-dimensional grid showing nested list indexing with row and basket coordinates](figures/04_groceries_veg00.png)
...
## Solution: Every Other Character
