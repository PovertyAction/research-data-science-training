...
abstract: |
  Learn to create effective data visualizations using Python's matplotlib library. Master plotting simple graphs, creating subplots, and customizing visualizations to gain insights from tabular data.
date: last-modified
format:
  html: default
authors-ipa:
...
keywords: ["Python", "Matplotlib", "Data Visualization", "Plotting", "Subplots", "Tutorial"]
license: "CC BY 4.0"
---
...
![Heat map representing the data variable with each cell colored by value along a blue to yellow gradient](figures/inflammation-01-imshow.svg)
...
![Line graph showing the average inflammation across all patients over a 40-day period](figures/inflammation-01-average.svg)
...
![Line graph showing the maximum inflammation across all patients over a 40-day period](figures/inflammation-01-maximum.svg)
...
![Line graph showing the minimum inflammation across all patients over a 40-day period](figures/inflammation-01-minimum.svg)
...
![Three line graphs showing the daily average, maximum and minimum inflammation over a 40-day period](figures/inflammation-01-group-plot.svg)
...
## Solution: Automated Y-axis Approach
...
![Three line graphs with step lines showing the daily average, maximum and minimum inflammation over a 40-day period](figures/inflammation-01-line-styles.svg)
:::
:::
...
## Solution: Standard Deviation Plot
