...
abstract: |
  Learn the fundamentals of Python programming including variables, data types, and built-in functions. Discover how to assign values to variables, work with integers, floats, and strings, and get help while programming.
date: last-modified
format:
  html: default
authors-ipa:
...
keywords: ["Python", "Programming Fundamentals", "Variables", "Data Types", "Functions", "Tutorial"]
license: "CC BY 4.0"
---
...
![Variable assignment illustrated as sticky notes on values](figures/python-sticky-note-variables-01.svg){alt='Value of 65.0 with weight_kg label stuck on it'}
...
![Two variables with their respective values](figures/python-sticky-note-variables-02.svg){alt='Value of 65.0 with weight_kg label stuck on it, and value of 143.0 with weight_lb label stuck on it'}
...
![Updated variable values showing independence](figures/python-sticky-note-variables-03.svg){alt='Value of 100.0 with label weight_kg stuck on it, and value of 143.0 with label weight_lb stuck on it'}
...
## Solution: Data Type Identification
