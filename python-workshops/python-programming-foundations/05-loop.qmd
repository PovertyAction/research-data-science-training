...
![Line graphs showing average, maximum and minimum inflammation across all patients over a 40-day period](figures/03-loop_2_0.png)
...
![Loop variable 'num' being assigned values from the list odds and printed in sequence](figures/05-loops_image_num.png)
