...
1. **Create a new folder** for your project:
   - Use File Explorer/Finder to create: `housing_analysis_project`
   - Or use Positron terminal: `mkdir housing_analysis_project`
...
4. **Create folders using terminal**:

   ```bash
   mkdir data notebooks scripts plots
   ```
...
2. **Activate environment**:
   - **Windows**: `housing_env\Scripts\activate`
   - **macOS/Linux**: `source housing_env/bin/activate`
...
::: {.callout-tip}
Always use virtual environments for projects to keep dependencies organized and avoid conflicts.
:::
...
2. Run the main script: `python scripts/housing_analysis.py`
