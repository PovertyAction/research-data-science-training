...
abstract: |
  Learn the fundamental concepts of version control, understand the difference between Git and GitHub, and explore the benefits of using version control systems for collaborative development.
date: last-modified
format:
  html: default
# authors-ipa:
...
keywords: ["Git", "GitHub", "Version Control", "Collaboration", "Tutorial", "Introduction"]
license: "CC BY 4.0"
---
