...
title: "Aggregations"
abstract: |
  Use the Distinct keyword to get a unique set of values. Use the 'group by' clause to summarise data. Use built-in statistical functions to provide column summaries. Use the 'having' clause to provide selection criteria to the summary values. Understand the difference between the 'where' and the 'having' clauses.
date: last-modified
...
keywords: ["SQL", "Database", "Tutorial", "Data Science", "Aggregation", "GROUP BY", "HAVING"]
license: "CC BY 4.0"
---
...
![](figures/SQL_06_villages.png){alt='Villages'}
