...
title: "Missing Data"
abstract: |
  Recognise what the database sees as missing data. Understand that the original data source may represent missing data differently. Define strategies for dealing with missing data.
date: last-modified
...
keywords: ["SQL", "Database", "Tutorial", "Data Science", "NULL", "Missing Data"]
license: "CC BY 4.0"
---
...
![](figures/SQL_04_Nulls_01.png){alt='Farms NULLs'}
...
![](figures/SQL_04_Nulls_02.png){alt='Farms\_csv'}
...
![](figures/SQL_04_Nulls_04.png){alt='Farms\_csv'}
