...
abstract: |
  Understand what ODBC is and when it can be used. Construct appropriate connection strings. Appreciate the advantages of using ODBC to access a remote database. Use an ODBC connection from Excel to retrieve data from a database. Use ODBC from Python or other programming environment to retrieve data from a database.
date: last-modified
...
keywords: ["SQL", "Database", "Tutorial", "Data Science", "ODBC", "Excel", "Python", "R"]
license: "CC BY 4.0"
---
...
![](figures/SQL_10_DataSource.png){alt='SQL\_10\_DataSource'}
...
![](figures/SQL_10_No_Tables.png){alt='SQL\_10\_No\_Tables'}

Click **OK** . The Choose Columns Windows appears to support the 'no tables' assertion.

![](figures/SQL_10_Choose_Columns.png){alt='SQL\_10\_Choose\_Columns'}
...
![](figures/SQL_10_Choose_Columns_2.png){alt='SQL\_10\_Choose\_Columns\_2'}
...
![](figures/SQL_10_return_data.png){alt='SQL\_10\_return\_data'}
...
![](figures/SQL_10_place_data.png){alt='SQL\_10\_place\_data'}
