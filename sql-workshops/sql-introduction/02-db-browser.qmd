...
abstract: |
  Understand the layout of the DB Browser for SQLite and the key facilities that it provides. Connect to databases. Create new databases and tables. Run SQL queries. Export the results of queries.
date: last-modified
...
keywords: ["SQL", "Database", "Tutorial", "Data Science", "DB Browser", "SQLite"]
license: "CC BY 4.0"
---
...
![](figures/DB_Browser_run_2.png){alt='Data Browser Preferences'}
...
![](figures/DB_Browser_run_3.png){alt='Table Actions'}
...
![](figures/DB_Browser_run_4.png){alt='SQL Query results'}
